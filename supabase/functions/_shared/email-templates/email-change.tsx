...
export default function EmailChangeEmail({ confirmationUrl, siteName = "Predict Politics", newEmail }: EmailChangeEmailProps) {
  ...
  return h(Html, null,
    ...
    h(Body, { style: main },
      h(Container, { style: container },
        ...
        h(Hr, { style: divider }),
        h(Text, { style: heading }, "Confirm email change"),
        h(Text, { style: paragraph },
          "Follow this link to confirm changing your email",
          newEmail ? ` to ${newEmail}` : "",
          ":"
        ),
        h(Section, { style: buttonSection },
          h("a", { href: confirmationUrl, style: button }, "CONFIRM EMAIL")
        ),
